    ...
    <>
      <form onSubmit={handleSubmit}>
        <div className="flex flex-row justify-center items-center">
          <div><input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Add a new todo item" className="my-10 mr-5 sm:mr-10 p-3 sm:p-4 text-center border rounded-2xl bg-white border-grey text-gray-900 " /></div>
